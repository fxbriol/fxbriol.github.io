...
[(***NIPS***)](https://papers.nips.cc/paper/6616-probabilistic-models-for-integration-error-in-the-assessment-of-functional-cardiac-models) [(***Conference***)](https://arxiv.org/abs/1606.06841) [(***Video***)](https://www.youtube.com/watch?v=SrrO4OxydO0&feature=youtu.be)

* ***Briol, F-X.***, Oates, C. J., Cockayne, J., Chen, W. Y. & Girolami, M. (2017). *On the Sampling Problem for Kernel Quadrature*. Proceedings of the 34th International Conference on Machine Learning, PMLR 70:586-595. [(***ICML***)](http://proceedings.mlr.press/v70/briol17a.html) [(***Conference***)](https://arxiv.org/abs/1706.03369) 
...
* ***Briol, F-X.*** & Girolami, M. (2018) Bayesian Numerical Methods as a Case Study for Statistical Data Science. [***Book***](https://www.worldscientific.com/doi/abs/10.1142/9781786345400_0006): pp. 99-110. 
