...
* ***UCL-Imperial CDT on Collaborative Computational Modelling at the Interface*** I am also eligible to be supervisor for students on the [CDT on Collaborative Computational Modelling at the Interface](https://ccmi-cdt.org) for more details). Students should apply directly to the CDT, and select a supervisor once they have received an offer.
