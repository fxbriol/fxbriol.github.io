...
My work has been recognised through a Blackwell-Rosenbluth Award, a Best Paper Award at AISTATS, a Discussion Paper in the journal Statistical Science, an honorary mention for the Savage Award, and my students have received a number of Best Student Paper Awards from the American Statistical Association (ASA) and the International Society for Bayesian Analysis (ISBA). I has also been supported through several EPSRC grants (including an EPSRC New Investigator Award and an EPSRC small grant in the mathematical sciences) and an Amazon Research Award.
