...
My research focuses on developing statistical and machine learning methods, and I am also interested in applications in the sciences and engineering. I enjoy designing methods to merge large-scale scientific models with data, which requires the development of novel computational methods, inference methods that remain robust to model misspecification, and tools for uncertainty quantification. 
