...
My work has been recognised through a Blackwell-Rosenbluth Award, a Best Paper Award at AISTATS, a Discussion Paper in the journal Statistical Science, and an honorary mention for the Savage Award. My students have also received a number of Best Student Paper Awards from the American Statistical Association (ASA) and the International Society for Bayesian Analysis (ISBA). Finally, my work has been funded through several EPSRC grants and an Amazon Research Award.
